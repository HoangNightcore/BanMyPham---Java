...
public class DlgSuaNhaCungCap extends javax.swing.JDialog {
    ...
    public DlgSuaNhaCungCap(Supplier nhaCungCap) {
        checkSuaNCC = false;
        ...
        txtMaNCC.setText(nhaCungCap.getSupplierID()+ "");
        txtTenNCC.setText(nhaCungCap.getSupplierName());
        txtDiaChiNCC.setText(nhaCungCap.getAddress());
        txtDienThoaiNCC.setText(nhaCungCap.getPhoneNumber());
    }
