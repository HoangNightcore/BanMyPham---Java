...
import BanMyPham.BUS.ThongKeBUS;
import BanMyPham.DTO.ThongKe;
import BanMyPham.GUI.Dialog.DlgLocThongKe;
...
public class PnQuanLyThongKeGUI extends javax.swing.JPanel {
    ...
    private void addControls() {
        ...
        lblBackgroundThucDon = new JLabel(new ImageIcon("image/ManagerUI/273511.png"));
...
//        pnThongKeTong.add(btn_filter);
    ...
    private void hienThiThongKe() {
        ...
        lblMon1.setText(thongKe.getTopSanPhamBanChay().get(0).getProductName());
        lblMon2.setText(thongKe.getTopSanPhamBanChay().get(1).getProductName());
        lblMon3.setText(thongKe.getTopSanPhamBanChay().get(2).getProductName());
        lblMon4.setText(thongKe.getTopSanPhamBanChay().get(3).getProductName());
        lblMon5.setText(thongKe.getTopSanPhamBanChay().get(4).getProductName());
        lblSoLuong1.setText("" + thongKe.getTopSanPhamBanChay().get(0).getQuantity());
        lblSoLuong2.setText("" + thongKe.getTopSanPhamBanChay().get(1).getQuantity());
        lblSoLuong3.setText("" + thongKe.getTopSanPhamBanChay().get(2).getQuantity());
        lblSoLuong4.setText("" + thongKe.getTopSanPhamBanChay().get(3).getQuantity());
        lblSoLuong5.setText("" + thongKe.getTopSanPhamBanChay().get(4).getQuantity());
    }
